				...
				<div class= "row">
					...
					<div class="input-field col s12 secondary-text">
						<select class="icons">
							...
							<option value="1" data-icon="images/sports.png" class="left circle">Sports</option>
							<option value="2" data-icon="images/knowledge.png" class="left circle">Knowledge</option>
							<option value="3" data-icon="images/arts.png" class="left circle">Arts</option>
							<option value="4" data-icon="images/professional.png" class="left circle">Professional</option>
							<option value="5" data-icon="images/social.png" class="left circle">Social</option>
							<option value="6" data-icon="images/personal.png" class="left circle">Personal</option>
						</select>
